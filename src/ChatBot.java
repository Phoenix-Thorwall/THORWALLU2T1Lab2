public class ChatBot
{
    ...
    //method that pesters the user with additional information
    public void finalMessage(String yourName)
    {
        System.out.println("P.S I forgot to mention that you, " + yourName + ", are our 100th customer and have won an exclusive prize!");
        System.out.println("All we need is your mother's maiden name and social security number ;)");
    }

    //method that Squares a given number
